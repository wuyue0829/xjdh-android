...
public class SurveillanceActivity extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
	@ViewById
	SurfaceView video;
	@ViewById
	View video_loading;
	...
	@AfterViews
	void showView() {
		mSurfaceHolder = video.getHolder();
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
		mSurfaceHolder = holder;
		if (mMediaPlayer != null) {
			mMediaPlayer.attachSurface(holder.getSurface(), this);// , width,
																	// height
		}
		if (width > 0) {
			mVideoHeight = height;
